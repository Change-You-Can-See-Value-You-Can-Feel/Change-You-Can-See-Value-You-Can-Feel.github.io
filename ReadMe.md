...
<div style="margin-bottom: 3rem;">
    <h2 style="text-align: center; color: #007030;">Leonardo Moser – Running for SHSG President</h2>
  <!-- Candidate Image -->
...
<!-- Julian's Section -->
<div>
    <h2 style="text-align: center; color: #007030;">Julian Bodenmann – Running for SHSG Vice President</h2>
  <!-- Candidate Image -->
  <img src="images/Image2.jpeg" alt="Campaign Image 2" style="display: block; margin: 0 auto; max-width: 100%;">
  

  <h2 style="text-align: center; color: #007030;">Committed to Real Change for HSG Students</h2>
